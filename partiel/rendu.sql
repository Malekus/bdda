...
-- Procedure qui donne la categorie et la sous-categorie qui possï¿½de le plus grande nombre d'occurence !
...
-- Fonction qui compte le nombre de valeur qui correspond a l'expression rÃ©guliÃ¨re
