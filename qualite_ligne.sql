...
create view test3(col1,col2,col3,col4,count) as select col5 from tabcli intersect select col1,col2,col3,col4,count(*) from tabcli group by col1,col2,col3,col4 having count(*)>1 order by col1 ;
