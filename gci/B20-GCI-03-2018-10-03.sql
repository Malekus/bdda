...
-- On considère que les données dans les tables CLIENTS2, ARTICLES2, COMMANDES2 et DETAILCOM2 sont celles du magasin FR01
...
-- Assemblez (intégrer, fusionner) dans une nouvelle DWBD l'ensemble des tables des différents magasins et tout le nécessaire
