...
-- Développer le nécessaire pour garder trace de tous les changements effectués dans la table des Clients !
...
On pourrait considérer que les deux clients « Ci » et « Cj » sont « amis » 
